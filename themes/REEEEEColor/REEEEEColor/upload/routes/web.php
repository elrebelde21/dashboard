...
use App\Classes\Settings\CustomTheme;
...
Route::middleware(['auth', 'checkSuspended'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->middleware('admin')->group(function () {
        ...
        //settings
        Route::patch('settings/update/customthemesettings', [CustomTheme::class, 'updateSettings'])->name('settings.update.customthemesettings');
